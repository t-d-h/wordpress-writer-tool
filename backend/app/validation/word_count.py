...
from app.cleaning.html_cleaner import HtmlCleaningService
...
class WordCountService:
    ...
    def count_words(html_content: Optional[str]) -> int:
        ...
        text_only = HtmlCleaningService.clean_html(html_content)
...
class WordCountValidator:
    ...
    def validate(self, html_content: str) -> dict:
        ...
        meets_min = self.min_words is None or self.word_count >= self.min_words
