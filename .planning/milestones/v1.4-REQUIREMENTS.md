# Requirements Archive: v1.4 Initial Admin Account on First Startup
...
- [x] **CONF-01**: System reads INIT_USER environment variable for admin username
- [x] **CONF-02**: System reads INIT_PASSWORD environment variable for admin password
- [x] **CONF-03**: System validates that INIT_USER is provided (non-empty string)
- [x] **CONF-04**: System validates that INIT_PASSWORD is provided (non-empty string)
- [x] **CONF-05**: System fails fast if INIT_USER or INIT_PASSWORD are missing or empty (no default values)
...
- [x] **CONFIG-01**: config.py includes INIT_USER field with default value
- [x] **CONFIG-02**: config.py includes INIT_PASSWORD field with default value
- [x] **CONFIG-03**: config.py validates INIT_USER and INIT_PASSWORD on startup
